...
<header class="flex justify-between items-center bg-[#724C9D]/90 w-full h-[76px] sticky top-0 text-lg text-white z-10">
  <a href="/" class="w-[15%] px-4">
  ...
  <!-- <div class="flex justify-end items-center gap-32 flex-grow"> -->
    <div class="w-[40%] flex items-center gap-2 place-content-between">
      <Search class="py-2 flex items-center" placeholder="Search Items..." bind:value={search}></Search>
